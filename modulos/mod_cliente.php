  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Origen/Destino</li>
      </ol>
    </section>
...
##  *** put a primary key on the first place 
	...
	$sql="SELECT id_tienda, tx_marca, (tx_descripcion) AS tx_descripcion2, tx_descripcion, tx_marca, tx_direccion, telefono_tienda, tx_url, correo_tienda, ('<i class=\"fa fa-info\"></i>') as icono_info FROM vie_tbl_tiendas ";

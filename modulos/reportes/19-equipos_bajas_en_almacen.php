...
<table class="mitabla table table-bordered table-striped" style="font-size:12px; color:#000; width:100%" >
  ...
  <?php 
    ...
    tx_marca,
    tx_modelo,
    (SELECT tx_nombre_tipo FROM cfg_tipo_producto WHERE a.id_tipo_producto=id_tipo_producto) as tx_nombre_tipo  FROM mod_producto a WHERE estatus=7 and ultimo_movimiento=1 and id_tienda=1 ";

...
<table class="mitabla table table-bordered table-striped" style="font-size:12px; color:#000; width:100% " >
  ...
  <tr style="background-color:#999">
	...
	<th width="30%" style="text-align:center" >TIENDA</th>
...
tx_serial,
tx_ngr,
(SELECT tx_placati FROM mod_producto WHERE id_producto=a.id_producto) as placati,
estatus_producto,
nx_cantidad,
...
tx_accesorios,
tx_observacion
FROM vie_tbl_movimiento a WHERE id_tipo_movimiento=1";

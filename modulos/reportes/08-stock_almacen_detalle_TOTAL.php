...
<table class="mitabla table table-bordered table-striped" style="font-size:12px; color:#000; width:100%" >
  ...
  <tr style="background-color:#999">
	...
	<th width="20%" style="text-align:center" >MARCA</th>
    <th width="20%" style="text-align:center" >MODELO</th>
  ...
  <?php 
    ...
    $sql="SELECT id_producto, (SELECT tx_descripcion FROM mod_tienda WHERE id_tienda=a.id_tienda) as tienda, 
    nx_cantidad,
    tx_serial,
    tx_marca,
    tx_modelo,
    tx_nombre_tipo FROM stock a WHERE  ultimo_movimiento=1 ";
  
	if (isset($_GET['tipo'])) $sql.=" AND tx_nombre_tipo='".$_GET['tipo']."'";

...
<h3>LISTA ENTRADAS INVENTARIO ALMACÉN</h3><hr>
<div class="col-lg-12" align="LEFT" style="font-size:14px; margin-left:10px; margin-bottom:10px;  ">AL <?php echo $_GET['fe_entrada']; ?></div>
</div>
<div class="col-lg-12" >
<table class="table table-bordered table-striped" style="font-size:12px; color:#000; width:100% " >
  ...
  <tr style="background-color:#999">
	...
	<th width="13%" style="text-align:center" >RESPONSABLE</th>
...
tx_accesorios,
tx_observacion
FROM vie_tbl_movimiento a WHERE id_tipo_movimiento=2";

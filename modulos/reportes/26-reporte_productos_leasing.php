	...
	<div style="margin-top:30px"> LISTADO DE EQUIPOS SEGUN TIPO DE COMPRA 
		<table class="mitabla table table-bordered table-striped" style="font-size:12px; color:#000; width:100%" >
		  ...
		  <tr style="background-color:#69add8">
			<th width="10%" style="text-align:center" >PROVEEDOR</th>
			<th width="10%" style="text-align:center" >COTIZACION</th>
			<th width="10%" style="text-align:center" >GUIA DE REMISION</th>
			<th width="10%" style="text-align:center" >FECHA DE INGRESO</th>
			<th width="10%" style="text-align:center" >GARANTIA</th>
			<th width="10%" style="text-align:center" >FECHA DE VENCIMIENTO</th>
			...
			<th width="10%" style="text-align:center" >TIPO DE COMPRA</th>
			<th width="10%" style="text-align:center" >N° LEASING / O.C. / PAGARE</th>
			<th width="10%" style="text-align:center" >ULTIMA UBICACION</th>
			<th width="10%" style="text-align:center" >RESPONSABLE</th>
		 ...
		 $sql.=" ORDER BY tienda ";
		  ...
		  <tr>
			...
			<td style="text-align:center"><?php echo $row2['nombre_origen_destino']."<br>".$row2['responsable']; ?></td>

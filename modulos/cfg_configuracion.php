  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">General del Sistema</li>
      </ol>
    </section>
...
##  ***  set settings for edit/details mode
  ...
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
	...
	"nu_port" =>array("header"=>"Puerto de Salida", "type"=>"textbox", "width"=>"100%", "req_type"=>"rny", "title"=>"", "unique"=>false),
	"tx_smtp" =>array("header"=>"SMTP Eléctronico", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),

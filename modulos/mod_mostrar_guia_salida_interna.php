...
date_default_timezone_set($_SESSION['zona_horario']);
			...
			$meses = array("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
				...
				$sql="SELECT tx_direccion,tx_guia,tx_descripcion, tx_ruc, tx_empresa, a.tx_marca, tx_ticket,  tx_proposito, (SELECT (tx_descripcion || ' ' || tx_url || ' ' || tx_observacion) from  mod_responsable_destino WHERE id_tienda=a.id_responsable_destino LIMIT 1) as tx_responsable, tx_representacion, (d.tx_responsable) as tecnico, fe_movimiento FROM mod_movimiento a, mod_tienda b, mod_empresa c, mod_responsable d WHERE a.tx_guia='".$_GET['guia']."' and id_tipo_guia=96  and a.id_tienda=b.id_tienda and c.id_empresa=b.id_empresa AND a.id_responsable_enviado=d.id_responsable";
				$res=abredatabase(g_BaseDatos,$sql);
				$row=dregistro($res);

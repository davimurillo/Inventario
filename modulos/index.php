	...
	<body class="hold-transition skin-blue sidebar-mini">
		<div class="wrapper">
			...
			<div class="content-wrapper">
								...
								<div class="box box-primary">
									...
									<div id="estadisticas_stock" class="box-body" >
										<table class="table table-bordered table-striped" style="font-size:14px; color:#000; width:100%" >
											...
											?>
												<tr>
													<td style="text-align:left" ><a href="reportes/27-stock_almacen_por_tipo.php?motivo=&proveedor=&origen=&fe_entrada=&ticket=&guia=&tipo=&tienda=<?php echo intval($row['ubicacion']); ?>" target="_blank" style="color:#000"><?php echo $row['ubicacion']; ?>   </a> </td>
				...
				<?php } else {?>
					<div  class="col-xs-12">
						<img src="repositorio/logos_cintillos/marcas.png" height="100%" width="100%">
					</div>

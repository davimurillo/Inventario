...
<div class="wrapper">
  ...
  <?php $formulario=24; include('barra_izquierda.php'); ?> 
...
##  *** put a primary key on the first place 
  $sql="select id_guia, tx_descripcion, serie, guia_desde, guia_hasta FROM cfg_guias";
...
##  *** set columns in view mode
 ...
 $vm_colimns = array(
	...
	"tx_descripcion"  =>array("header"=>"Descripción",      "type"=>"label", "width"=>"40%", "align"=>"left",    "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal"),
	"serie"  =>array("header"=>"Serie",      "type"=>"label", "width"=>"10%", "align"=>"center",    "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal"),
	"guia_desde"  =>array("header"=>"Desde",      "type"=>"label", "width"=>"20%", "align"=>"center",    "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal"),
	"guia_hasta"  =>array("header"=>"Hasta",      "type"=>"label", "width"=>"20%", "align"=>"center",    "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal")
...
##  ***  set settings for edit/details mode
  ...
  $estatus=array("0"=>"Inactivo", "1"=>"Activo");
  $table_name = "cfg_guias";
  $primary_key = "id_guia";
  $condition = "";
  ...
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
    ...
    "tx_descripcion" =>array("header"=>"Descripción", "type"=>"textbox", "width"=>"100%", "req_type"=>"ry", "title"=>"Descricpión", "unique"=>false),
    "serie" =>array("header"=>"N° de Serie", "type"=>"textbox", "width"=>"210px", "req_type"=>"ry", "title"=>"Número de Serie de la Guia", "unique"=>false),
    "guia_desde" =>array("header"=>"N° de Guía Desde", "type"=>"textbox", "width"=>"210px", "req_type"=>"ry", "title"=>"Número de Guía Desde", "unique"=>false),
    "guia_hasta" =>array("header"=>"N° de Guía Hasta", "type"=>"textbox", "width"=>"210px", "req_type"=>"ry", "title"=>"Número de Guía Hasta", "unique"=>false),
	"estatus" =>array("header"=>"Estatus",  "type"=>"enum",  "default"=>"1",  "source"=>$estatus, "view_type"=>"dropdownlist",  "width"=>"20px", "req_type"=>"rt", "title"=>""),

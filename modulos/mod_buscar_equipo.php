...
?>	
					<div class='col-xs-12'>
						...
						<div class="col-xs-<?php  if (isset($_POST['f']) && $_POST['f']==1) { echo '6'; } else { echo '4'; } ?>">
							<label>Descripción</label><br>
							<span><?php echo $row2['tx_descripcion']; ?><br> <b>Tipo:</b> <?php echo $row2['id_tipo_producto']; ?>, <b>Marca:</b> <?php echo $row2['tx_marca']; ?>, <b>Placa:</b> <?php echo $row2['tx_ngr']; ?>, <b>Modelo:</b> <?php echo $row2['tx_modelo']; ?>.
						</div>

...
?>
 <!-- Head app -->
  ...
  <?php $formulario=14; include('barra_izquierda.php'); ?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Configuración
        <small>Tipo de Equipos</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Tipo de Equipos</li>
      </ol>
    </section>
	...
	<div align="right" class="col-xs-6">
		   <form action="cfg_tipo_equipo.php" method="GET">			 <strong>Buscar Tipo de Equipo:</strong>
...
##  *** put a primary key on the first place 
	...
	$sql="SELECT id_tipo_producto, tx_nombre_tipo, nx_min, nx_max, nx_orden, CASE WHEN id_tipo_carga=0 THEN 'N/A' WHEN id_tipo_carga=1 THEN 'UNICO' ELSE 'MASIVO' END AS tipo_carga FROM cfg_tipo_producto  WHERE 1=1";

	if (isset($_GET['buscar_equipo_general'])){
		$sql.=" AND tx_nombre_tipo LIKE '%".strtoupper($_GET['buscar_equipo_general'])."%'";
	}
##  *** set needed options
  $debug_mode = false;
  $messaging = true;
...
##  *** set data source with needed options
  $default_order_field = "tx_nombre_tipo";
...
##  *** set columns in view mode
  ...
  $dgrid->SetViewModeTableProperties($vm_table_properties); 
	...
	"id_tipo_producto"  =>array("header"=>"ID","header_align"=>"center","type"=>"label", "width"=>"5%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	
	"tx_nombre_tipo"  =>array("header"=>"Nombre","header_align"=>"center","type"=>"label", "width"=>"45%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	
	"nx_min"  =>array("header"=>"Min. Stock","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"center",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	
	"nx_max"  =>array("header"=>"Max. Stock","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"center",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	
	"nx_orden"  =>array("header"=>"Orden","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"center",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	
	"tipo_carga"  =>array("header"=>"Tipo","header_align"=>"center","type"=>"label", "width"=>"20%", "align"=>"center",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal")
...
##  ***  set settings for edit/details mode
  ...
  $tipo_array = array(""=>"-Seleccione-","1"=>"Unico", "2"=>"Masivo");
  $table_name = "cfg_tipo_producto";
  $primary_key = "id_tipo_producto";
  $condition = "";
  $dgrid->setTableEdit($table_name, $primary_key, $condition);
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
 	
	"tx_nombre_tipo" =>array("header"=>"Tipo de Equipo", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	
	"nx_min" =>array("header"=>"Stock Min", "type"=>"textbox", "width"=>"100%", "req_type"=>"rny", "title"=>"", "unique"=>false),
	
	"nx_max" =>array("header"=>"Stock Max", "type"=>"textbox", "width"=>"100%", "req_type"=>"rny", "title"=>"", "unique"=>false),
	
	"nx_orden" =>array("header"=>"Orden", "type"=>"textbox", "width"=>"100%", "req_type"=>"rny", "title"=>"", "unique"=>false),
	
	"id_tipo_carga" =>array("header"=>"Tipo de Carga",  "type"=>"enum",   "source"=>$tipo_array, "view_type"=>"dropdownlist",  "width"=>"20px", "req_type"=>"rt", "title"=>""),
	
	"id_estatu" =>array("header"=>"Estatus",  "type"=>"enum",  "default"=>"1",  "source"=>$estatus_array, "view_type"=>"dropdownlist",  "width"=>"20px", "req_type"=>"rt", "title"=>""),

...
?>
 <!-- Head app -->
  ...
  <?php $formulario=11;  include('barra_izquierda.php'); ?> 
...
##  *** put a primary key on the first place 
	...
	$sql="SELECT id_almacen, tx_codigo, tx_nombre, tx_direccion, tx_telefonos, estatus FROM mod_almacen";
...
##  ***  set settings for edit/details mode
  ...
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
	...
	"tx_telefonos" =>array("header"=>"Telefonos", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),

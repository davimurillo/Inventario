...
?>
 <!-- Head app -->
  ...
  <?php $formulario=28; include('barra_izquierda.php'); ?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Configuración
        <small>Tipo de Marcas de Equipos</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Tipo de Marcas</li>
      </ol>
    </section>
	...
	<div align="right" class="col-xs-6">
		   <form action="cfg_tipo_marcas.php" method="GET">			 <strong>Buscar Tipo de Marcas:</strong>
...
##  *** put a primary key on the first place 
	...
	if (isset($_GET['buscar_equipo_general'])){
		$sql.=" WHERE tx_marca LIKE '%".strtoupper($_GET['buscar_equipo_general'])."%'";
	}
##  *** set needed options
  $debug_mode = false;
  $messaging = true;
...
##  *** set columns in view mode
  ...
  $dgrid->SetViewModeTableProperties($vm_table_properties); 
	...
	"id_marca"  =>array("header"=>"ID","header_align"=>"center","type"=>"label", "width"=>"5%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	
	"tx_marca"  =>array("header"=>"Marca","header_align"=>"center","type"=>"label", "width"=>"95%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),

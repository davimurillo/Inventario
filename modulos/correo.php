...
if ($_POST['tipo_correo']==1){
	 ...
	 $sql="SELECT tx_nombre_tipo,tx_marca,tx_modelo, tx_serial, tx_accesorios, tx_ngr, nx_cantidad, (SELECT tx_correo FROM mod_responsable WHERE id_responsable=vie_tbl_movimiento.id_responsable_enviado) as tx_correo	FROM vie_tbl_movimiento WHERE tx_guia='".$_POST['guia']."' and fe_movimiento='".$_POST['fecha']."'";
	$res=abredatabase(g_BaseDatos,$sql);
	$contenido="";
...
$mail->AddEmbeddedImage('repositorio/logos_cintillos/logo_sistema.png', 'logo1');

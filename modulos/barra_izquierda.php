		...
		<?php }else { ?>
			  ...
			  <ul class="treeview-menu">
				<li class="<?php if($formulario==4){ echo "active"; } ?>"><a href="mod_registro_equipos_accesorios.php"><i class="fa fa-desktop"></i> Equipos y/o Accesorios</a></li>
				 <!-- <li class="<?php if($formulario==5){ echo "active"; } ?>"><a href="mod_personal.php"><i class="fa fa-street-view "></i> Supervisores</a></li> -->
				  <li class="<?php if($formulario==21){ echo "active"; } ?>"><a href="mod_responsable_destino.php"><i class="fa fa-users"></i> Tienda/Colaborador</a></li>
				...
				<li class="<?php if($formulario==8){ echo "active"; } ?>"><a href="mod_cliente.php"><i class="fa fa-list-ul"></i> Ubicacion (TDA - Sede/ Área)</a></li>
			...
			<li class="class="<?php if($formulario==9 ){ echo "active"; } ?> treeview">
			  ...
			  <ul class="treeview-menu">
			   ...
			   <ul class="treeview-menu">
				<li class="<?php if($formulario==9){ echo "active"; } ?>"><a href="mod_filtros.php"><i class="fa fa-print"></i> Filtros</a></li>
			  </ul>
			</li>
		<?php } ?>
		<?php if ($_SESSION['rol']==4){ ?>

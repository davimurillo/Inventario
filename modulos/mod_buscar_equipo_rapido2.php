...
$producto = isset($_GET['buscar']) ? strtoupper ($_GET['buscar']) : " "; 
 ...
 $sql="SELECT id_producto, tx_serial, tx_descripcion, tx_tipo_producto, tx_marca, tx_modelo,  (SELECT n_stock FROM mod_producto WHERE id_producto=d.id_producto)  as existencia  FROM vie_tbl_equipos d WHERE upper(tx_serial) LIKE '%".strtoupper($producto)."%' OR  upper(tx_descripcion) LIKE '%".strtoupper($producto)."%' OR upper(tx_tipo_producto) LIKE '%".strtoupper($producto)."%' OR upper(tx_marca) LIKE '%".strtoupper($producto)."%' OR  upper(tx_modelo) LIKE '%".strtoupper($producto)."%'  ";

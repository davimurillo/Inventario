...
##  *** put a primary key on the first place 
	...
	$sql="SELECT id_modulo, tx_modulo, n_orden FROM cfg_modulo";
...
##  *** set data source with needed options
  $default_order_field = "id_modulo, n_orden ";
...
##  *** set columns in view mode
  ...
  $dgrid->SetViewModeTableProperties($vm_table_properties); 
	...
	"tx_modulo"  =>array("header"=>"Modulo","header_align"=>"center","type"=>"label", "width"=>"90%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"n_orden"  =>array("header"=>"Orden","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"center",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal")
...
##  ***  set settings for edit/details mode
  ...
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
	...
	"tx_modulo" =>array("header"=>"Nombre del Modulo", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	"n_orden" =>array("header"=>"Nº de Orden", "type"=>"textbox", "width"=>"100%", "req_type"=>"rny", "title"=>"", "unique"=>false),
	"tx_archivo" =>array("header"=>"Archivo", "type"=>"file",       "req_type"=>"st", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "target_path"=>"", "max_file_size"=>"1M", "file_name"=>"", "host"=>"local", "allow_downloading"=>"false", "allowed_extensions"=>""),
	"id_estatu" =>array("header"=>"Estatu",  "type"=>"enum",  "default"=>"1",  "source"=>$estatus_array, "view_type"=>"dropdownlist",  "width"=>"20px", "req_type"=>"rt", "title"=>""),
	"tx_icono" =>array("header"=>"Icono", "type"=>"textbox", "width"=>"100%", "req_type"=>"sty", "title"=>"", "unique"=>false)

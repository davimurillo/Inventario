...
?>
 <!-- Head app -->
  ...
  <?php $formulario=7; include('barra_izquierda.php'); ?> 
...
##  *** put a primary key on the first place 
	...
	$sql="SELECT id_proveedor, tx_ruc, tx_nombre, tx_direccion, tx_telefono, tx_url, tx_correo, (SELECT tx_tipo FROM vie_tbl_estatus_proveedor WHERE id_tipo_objeto=mod_proveedor.estatus) AS estatus FROM mod_proveedor ";
	
	if (isset($_GET['buscar_proveedor'])){
		$sql.=" WHERE upper(tx_nombre) LIKE '%".strtoupper($_GET['buscar_proveedor'])."%' OR tx_ruc LIKE '%".strtoupper($_GET['buscar_proveedor'])."%'  OR tx_direccion LIKE '%".strtoupper($_GET['buscar_proveedor'])."%' OR tx_telefono LIKE '%".strtoupper($_GET['buscar_proveedor'])."%'  OR tx_correo LIKE '%".strtoupper($_GET['buscar_proveedor'])."%' ";
	}
...
##  *** set columns in view mode
  ...
  $dgrid->SetViewModeTableProperties($vm_table_properties); 
	...
	"id_proveedor"  =>array("header"=>"ID","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	
	"tx_ruc"  =>array("header"=>"RUC","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	
	"tx_nombre"  =>array("header"=>"Nombre","header_align"=>"center","type"=>"label", "width"=>"30%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	
	"tx_direccion"  =>array("header"=>"Dirección","header_align"=>"center","type"=>"label", "width"=>"25%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	...
	"tx_url"  =>array("header"=>"WEB","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
 ...
 //*****ARREGLO PARA ESTATUS ******//
  ...
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
	...
	"tx_ruc" =>array("header"=>"N° RUC", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	
	"tx_nombre" =>array("header"=>"Nombre", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	
	"tx_descripcion" =>array("header"=>"Descripción", "type"=>"textarea", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	
	"tx_direccion" =>array("header"=>"Dirección", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	
	"tx_url" =>array("header"=>"Dirección WEB", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	
	"tx_telefono" =>array("header"=>"Telefonos", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	
	"tx_correo" =>array("header"=>"Correo", "type"=>"email", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	
	"estatus" =>array("header"=>"Estatu",  "type"=>"enum",  "default"=>"1",  "source"=>$estatus_array, "view_type"=>"dropdownlist",  "width"=>"20px", "req_type"=>"rt", "title"=>""),

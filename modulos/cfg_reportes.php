...
?>
 <!-- Head app -->
  ...
  <?php $formulario=15; include('barra_izquierda.php'); ?> 
...
##  *** put a primary key on the first place 
  $sql="select id_reporte, tx_reporte, tx_archivo from cfg_reportes";
...
##  *** set data source with needed options
  $default_order_field = "tx_reporte";
...
##  *** set columns in view mode
 ...
 $vm_colimns = array(
	...
	"tx_reporte"  =>array("header"=>"Reporte",      "type"=>"label", "width"=>"50%", "align"=>"left",    "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal"),
	"tx_archivo"  =>array("header"=>"Archivo",      "type"=>"label", "width"=>"50%", "align"=>"left",    "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal"),
...
##  ***  set settings for edit/details mode
  ...
  $table_name = "cfg_reportes";
  $primary_key = "id_reporte";
  $condition = "";
  $dgrid->setTableEdit($table_name, $primary_key, $condition);
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
    
    "tx_reporte" =>array("header"=>"Nombre del Reporte", "type"=>"textbox", "width"=>"210px", "req_type"=>"ry", "title"=>"Nombre del Reporte", "unique"=>false),
	"tx_archivo" =>array("header"=>"Archivo del Reporte", "type"=>"file",       "req_type"=>"rt", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "target_path"=>"reportes/", "max_file_size"=>"2M", "host"=>"local"),
